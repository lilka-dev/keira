...
public:
    ...
    explicit KeiraThread(
        KeiraCallback clbk = NULL, const char* ktName = NULL, uint32_t ktStackSize = KT_STACK,
        KeiraCallbackData data = NULL, KeiraThreadPriority ktPriority = KT_PRIO_DEFAULT, int ktCore = KT_CORE
    );
    virtual ~KeiraThread();
    //////////////////////////////////////////////////////////////////////////
    //=======================================================================
