...
#define LEP keira_log_entry_point(__FILE__, __LINE__, __PRETTY_FUNCTION__);
#define LXP keira_log_exit_point(__FILE__, __LINE__, __PRETTY_FUNCTION__);
...
// Usage of it everywhere isn't guaranteed, simply cause some functions may be run too often, though, our goal is to provide an instrument
//============================================================================
