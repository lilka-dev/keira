...
---@field fullscreen boolean Відображати додаток на весь екран (за замовчуванням ``true``). Якщо встановити ``false``, буде видно статусбар. Наприклад: ``lilka.fullscreen = false``
lilka = {}
